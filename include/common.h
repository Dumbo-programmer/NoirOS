...
#define ATTR_TITLE        VGA_ATTR(COL_LIGHT_CYAN,    COL_BLUE)
#define ATTR_SELECTED     VGA_ATTR(COL_BLACK,         COL_LIGHT_CYAN)
#define ATTR_BORDER       VGA_ATTR(COL_CYAN,          COL_BLACK)
#define ATTR_STATUS       VGA_ATTR(COL_LIGHT_CYAN,    COL_BLACK)
#define ATTR_ERROR        VGA_ATTR(COL_LIGHT_RED,     COL_BLACK)
#define ATTR_SUCCESS      VGA_ATTR(COL_LIGHT_CYAN,    COL_BLACK)
#define ATTR_PROMPT       VGA_ATTR(COL_LIGHT_CYAN,    COL_BLACK)
#define ATTR_DIR          VGA_ATTR(COL_LIGHT_CYAN,    COL_BLACK)
#define ATTR_FILE_TEXT    VGA_ATTR(COL_LIGHT_GREY,    COL_BLACK)
#define ATTR_FILE_MD      VGA_ATTR(COL_LIGHT_CYAN,    COL_BLACK)
#define ATTR_FILE_HTML    VGA_ATTR(COL_LIGHT_CYAN,    COL_BLACK)
#define ATTR_FILE_NOIRC   VGA_ATTR(COL_LIGHT_CYAN,    COL_BLACK)
#define ATTR_FILE_EXE     VGA_ATTR(COL_LIGHT_RED,     COL_BLACK)
#define ATTR_VIEWER_BG    VGA_ATTR(COL_LIGHT_GREY,    COL_BLACK)
#define ATTR_VIEWER_TITLE VGA_ATTR(COL_LIGHT_CYAN,    COL_BLUE)
#define ATTR_NOIRC_OUTPUT VGA_ATTR(COL_LIGHT_CYAN,    COL_BLACK)
#define ATTR_NOIRC_ERROR  VGA_ATTR(COL_LIGHT_RED,     COL_BLACK)
#define ATTR_NOIRC_PROMPT VGA_ATTR(COL_LIGHT_CYAN,    COL_BLACK)
